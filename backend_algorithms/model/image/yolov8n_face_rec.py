...
class YOLOv8_face:
    ...
    def detect(self, srcimg):
        ...
        input_img, newh, neww, padh, padw = self.resize_image(srcimg)
...
def model_run(
    ...
    model_path = current_file_path.parent.parent / "weights" / "yolov8n-face.onnx"
    ...
    return {
        "objects": [
            ...
            for (x, y, w, h), score in zip(boxes.tolist(), scores.tolist())
        ]
    }
